...
- Converts to HTML
- Used in blogging engines the world over
- Markdown + R bits -> R Markdown

## Code "chunks"

- Surround code chunks with triple back-ticks and `{r your-chunk-name}`
...
<!-- Enclosing code sections with ``` but without {r} prints but does not execute the code. -->
